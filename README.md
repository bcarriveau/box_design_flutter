...
- **Falcon controllers not listed above**: generic placeholders — no official dimensions are published for these; replace via Import once you have a real DXF or measurement.
